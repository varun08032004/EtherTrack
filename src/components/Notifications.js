...
const FILTERS = ['ALL', 'TRADE', 'PRICE', 'KYC', 'EMISSION', 'WALLET', 'SYSTEM'];
  ...
  return (
    <>
      <style>{`
        ...
        .et-notif-wrap { position: relative; z-index: 1; max-width: 760px; margin: 0 auto; padding: 40px 24px; }
        ...
        .et-notif-actions { display: flex; gap: 8px; }
        .et-notif-action-btn {
        ...
        .et-notif-filter {
          padding: 6px 14px; border-radius: 5px; font-size: 10px; letter-spacing: .1em;
          border: 1px solid #0f2a1a; background: transparent; cursor: pointer;
          font-family: 'DM Mono', monospace; color: #4ade8055; transition: all .2s;
        }
        ...
        .et-notif-item-body { flex: 1; min-width: 0; }
        .et-notif-item-row  { display: flex; align-items: center; gap: 8px; margin-bottom: 4px; }
        ...
        .et-notif-item-act {
          ...
          border: 1px solid #0f2a1a; background: #060a07; cursor: pointer;
          font-family: 'DM Mono', monospace; color: #4ade8055; transition: all .2s;
        }
        ...
        @media (max-width: 600px) { .et-notif-topbar { flex-direction: column; align-items: flex-start; } }
      `}</style>
      ...
      <div className="et-notif">
        <div className="et-notif-wrap">
          ...
          <div className="et-notif-sub">STAY UP TO DATE WITH YOUR TRADES AND ACTIVITY</div>
          ...
          <div className="et-notif-topbar">
            ...
            <div className="et-notif-actions">
              {unreadCount > 0 && (
                <button className="et-notif-action-btn" onClick={markAllRead}>
                  MARK ALL READ
                </button>
              )}
              {notifications.length > 0 && (
                <button className="et-notif-action-btn danger" onClick={clearAll}>
                  CLEAR ALL
                </button>
              )}
            </div>
          ...
          <div className="et-notif-list">
            {filtered.length === 0 ? (
              <div className="et-notif-empty">
                <div className="et-notif-empty-icon">🎉</div>
                <div className="et-notif-empty-title">All caught up!</div>
                <div className="et-notif-empty-sub">No notifications in this category</div>
              </div>
            ) : filtered.map(n => {
              ...
              return (
                <div
                  key={n.id}
                  className={`et-notif-item${!n.read ? ' unread' : ''}`}
                ...
                >
                  ...
                  <div className="et-notif-item-body">
                    ...
                    <div className="et-notif-item-time">{timeAgo(n.time)}</div>
                  </div>
                  {!n.read && <div className="et-notif-item-unread-dot" />}

                  <div className="et-notif-item-actions">
                    {!n.read && (
                      <button
                        className="et-notif-item-act"
                    ...
                    <button
                      className="et-notif-item-act del"
