          ...
          <div className="et-th-card">
            ...
            {loading?.trades ? (
              ...
              <div className="et-th-empty">
                {rows.length === 0 ? 'No trades yet — your transactions will appear here.' : 'No transactions match your filters.'}
              </div>
            ) : (
              currentEntries.map((t, i) => (
                ...
                >
                  <span style={{ color: '#4ade8066', fontSize: 10 }}>{t.id}</span>
                  <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', paddingRight: 8 }}>{t.market}</span>
