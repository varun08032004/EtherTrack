// ─────────────────────────────────────────────────────────────
//  contracts.config.js
//  Single source of truth for all contract addresses + ABIs
...
// These come from deployments/*.env after running deploy.js
export const CONTRACT_ADDRESSES = {
  ...
  [NETWORKS.POLYGON.chainId]: {
    KYCRegistry:       process.env.REACT_APP_POLYGON_KYC_REGISTRY_ADDRESS        || '',
    CarbonCreditToken: process.env.REACT_APP_POLYGON_CARBON_CREDIT_TOKEN_ADDRESS  || '',
    Marketplace:       process.env.REACT_APP_POLYGON_MARKETPLACE_ADDRESS          || '',
    EmissionRegistry:  process.env.REACT_APP_POLYGON_EMISSION_REGISTRY_ADDRESS    || '',
    Treasury:          process.env.REACT_APP_POLYGON_TREASURY_ADDRESS             || '',
  },
};
...
export const ABIS = {
  ...
  EmissionRegistry: [
    ...
    'function totalEmissionLogs() view returns (uint256)',
